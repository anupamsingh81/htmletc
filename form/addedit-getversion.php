...
if (ini_get('allow_url_fopen') == '1') {
	// --- get full website address of addedit directory (done elsewhere but scope issues; also only useful b/c many servers have open_basedir restrictions)
	...
	if ($fp = fopen($host.'/'.$thisdir.'/includes/version.inc.php', 'r')) {
		$content = '';
